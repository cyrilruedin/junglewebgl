...
/*
  ...
  if(quat.getAxisAngle([1, 0, 0], myQuaternion) != 0){
    console.log(rx);
    console.log(ry);
    var a = vec3.fromValues(1,0,0);
    console.log(quat.getAxisAngle(a, rotXQuat));
    console.log(a);
    console.log(quat.getAxisAngle(vec3.fromValues(0,1,0), rotXQuat));
    console.log(quat.getAxisAngle(vec3.fromValues(0,0,1), rotXQuat));
  }
